...
function isStringArray(arr:Array<any>):arr is Array<string> {
...
function joinChunks(chunks:Array<Array<string>>, start: Array<string>) {
  let result = [start]
...
console.log(chunkToString(joinChunks(tokenChunk, tokenChunk[0])))